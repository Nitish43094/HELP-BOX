...
class Password{
	...
	public:
		void CreateProfile()
		{
			ofstream fout("Password.txt",ios::app|ios::binary);
			gotoxy(60, 0);
			cout<<"+-------------------------------------------+\n";
			gotoxy(60, 1);
			cout<<"|Enter the Name :                           |\n";
...
//---------------------------------------------------------------------
		void UpdateProfile()
		{
			ifstream fin("Password.txt",ios::in|ios::binary);
...
//-----------------------------------------------------------------
		...
		void Profile()
		{
			...
			while(fin.read((char*)this,sizeof(*this)))
			{
				string phar="Hello Nitish Kumar Kushwaha";
				string command="espeak \""+ phar +"\"";
				const char *CharCommand=command.c_str();
				system(CharCommand);
				gotoxy(60, 0);
